...
/**
 * help_all - shows all possible builtin shellby commands.
 */
void help_all(void)
{
...
/**
 * help_cd - Displays information about the shellby builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays particulars on the shellby builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays details on the shellby builtin command 'help'.
 */
void help_help(void)
{
